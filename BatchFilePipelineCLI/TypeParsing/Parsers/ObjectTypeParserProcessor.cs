...
{
    /// <summary>
    /// Blanket handle the converting of all values to object
    /// </summary>
    [Preserve]
    internal sealed class ObjectTypeParserProcessor : ITypeParserProcessor
    {
        /*----------Variables----------*/
        //PRIVATE
        ...
        public bool CanProcessOutputType(Type targetType) => targetType == OBJECT_TYPE;
