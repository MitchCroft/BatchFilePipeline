...
using ManifestData = System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, string>>;
...
namespace BatchFilePipelineCLI.Pipeline.Nodes.Manifest
{
    ...
    /// </summary>
    public abstract class ManifestNodeBase : INode
    {
        /*----------Variables----------*/
        //PROTECTED
        ...
        public abstract ValueTask<ExecutionResult> ProcessNodeResultAsync(PipelineContext context);
