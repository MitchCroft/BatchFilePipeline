...
namespace BatchFilePipelineCLI.Pipeline.Nodes.External.SSH.Utility
{
    /// <summary>
    ...
    public static class SSHFileIOUtility
    {
                                                                 ...
                                                                 CancellationToken cancellationToken)
        {
            ...
            string[] segments = IOUtility.CleanFilePath(path).Split('/', StringSplitOptions.RemoveEmptyEntries);
                                                          ...
                                                          bool allowOverwrite = false)
        {
            ...
            using var reader = sftp.OpenRead(IOUtility.CleanFilePath(source));
            using var writer = sftp.Open(IOUtility.CleanFilePath(destination), allowOverwrite ? FileMode.Create : FileMode.CreateNew);
