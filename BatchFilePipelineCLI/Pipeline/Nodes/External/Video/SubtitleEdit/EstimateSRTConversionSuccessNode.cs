...
using BatchFilePipelineCLI.Pipeline.Nodes.External.Video.SubtitleEdit.Data;
using BatchFilePipelineCLI.Pipeline.Nodes.External.Video.Utility;
using BatchFilePipelineCLI.Pipeline.Runners;
using BatchFilePipelineCLI.PropertyResolver;
using System.Collections;

namespace BatchFilePipelineCLI.Pipeline.Nodes.External.Video.SubtitleEdit
{
    /// <summary>
    /// Estimate the successful conversion of an SRT subtitle file based on a dictionary of words that can be comparsed against
    /// </summary>
    [Node]
    public sealed class EstimateSRTConversionSuccessNode : INode
    {
        /*----------Variables----------*/
        //PRIVATE
