...
namespace BatchFilePipelineCLI.Pipeline.Nodes.External.Video.FFprobe
{
    /// <summary>
    /// Provide a base type for handling the functionality of programs wrapped in a Node interface
    /// </summary>
    [Node]
    public sealed class GetVideoDetailsNode : INode
    {
        /*----------Variables----------*/
        //PROTECTED
        ...
        public async ValueTask<ExecutionResult> ProcessNodeResultAsync(PipelineContext context)
        {
            ...
            string target = context.GetInput<string>(_targetProperty);
