...
namespace BatchFilePipelineCLI.Pipeline.Nodes.External.Video.Utility
{
    /// <summary>
    ...
    public static class SubtitleDataStreamUtility
    {
        ...
        {
            return stream.GetExportName(stream.GetCodecExtension());
        }
        ...
        {
            return $"{stream.GetExportNameWithoutExtension()}{extension}";
        }
        ...
        {
            return stream.TryFindSubtitleFile(directory, stream.GetCodecExtension(), out filePath);
        }
        ...
        {
            string fileName = stream.GetExportNameWithoutExtension();
